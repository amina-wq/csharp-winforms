...
namespace IOOP_assignment.Models
{
    ...
    {
        public static Guid ToUUID(Role role)
        {
            switch (role)
            {
                case Role.Administrator:
                    return Guid.Parse("2b1fa860-fabb-4d8e-850d-a4dfec450263");
                case Role.Manager:
                    return Guid.Parse("c8b557ca-e21a-43a5-96bb-c86e25990d8d");
                case Role.Chef:
                    return Guid.Parse("31f1e389-3856-4fa1-a29e-f3d9831c1b65");
                case Role.Customer:
                    return Guid.Parse("f2c0795c-0aa5-489d-90f5-21a07d1deda9");
                default:
